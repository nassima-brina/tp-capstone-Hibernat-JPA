...
public class App {
    public static void main(String[] args) {
        System.out.println("=== SYSTÈME DE GESTION DES SALLES ===");
        ...
        try {
            ...
            while (!exit) {
                ...
                System.out.println("2.Lancer les tests");
                System.out.println("3.  Migration de la base");
                System.out.println("4. Rapport de performances");
